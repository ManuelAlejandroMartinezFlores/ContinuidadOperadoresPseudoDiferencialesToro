...
\def \nombreprimerex {Dr. Alan Reyes-Figueroa}
% Nombre del segundo examinador
\def \nombresegundoex {MS. Dorval Car\'ias}
\def \nombretercerex {MS. Rodrigo Leonardo}
% Fecha de aprobación
\def \fechaaprobacion {3 de diciembre de 2025}
